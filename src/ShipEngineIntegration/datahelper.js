        ...
        const xmlData = {
            UniversalShipment: {
                ...
                Shipment: {
                    ...
                    NoteCollection: {
                        $: { Content: "Partial" },
                        Note: { Description: "Internal Work Notes", IsCustomDescription: false, NoteText: JSON.stringify(error, null, 2) + lineBreak, NoteContext: { Code: "AAA" }, Visibility: { Code: "INT" } },
                    },
                },
            },
        };
